                ...
                <form action="/categorias/edit/<?php echo $actual['id_categoria'] ?>"" method="post">         
                    ...
                    <div class="row">
                        <div class="mb-3 col-sm-3">
                            ...
                            <input class="form-control" id="id_categoria" type="text" name="id_categoria" placeholder="<?php echo $actual['id_categoria'] ?>" value="<?php echo isset($input['id_categoria']) ? $input['id_categoria'] : $actual['id_categoria']; ?>" required>
