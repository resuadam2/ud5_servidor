    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div
                ...
                <h6 class="m-0 font-weight-bold text-primary">Datos completos del Usuario del Sistema</h6>                                    
            </div>
            <!-- Card Body -->
            <div class="card-body">                   
                <!-- <form method="get"> -->
                <div class="row">
                    ...
                    <div class="mb-3 col-sm-3">
                        ...
                        <input class="form-control-plaintext" id="id_rol" type="text" name="id_rol" placeholder="<?php echo $controller->getNombreRol($usuario['id_rol']); ?>" disabled>
                    </div>
                    ...
                    <div class="">
                        <a href="/usuarios_sistema" class="btn btn-default">Volver</a>
                    </div>
                </div>
                </form>
            </div>
