...
class FrontController {
    ...
    static function main() {
        ...
        if (isset($_SESSION['id_usuario'])) {
            ...
            $aux = new \Com\Daw2\Models\UsuarioSistemaModel();
            $temp = $aux->getNombreRol($_SESSION['rol'])[0];
            if ($temp['nombre_rol'] == 'administrador') {
            ...
            if ($temp['nombre_rol'] == 'administrador' || $temp['nombre_rol'] == 'categorias') {
            ...
            if ($temp['nombre_rol'] == 'administrador' || $temp['nombre_rol'] == 'productos') {
            ...
            if ($temp['nombre_rol'] == 'administrador' || $temp['nombre_rol'] == 'proveedores') {
